...
namespace DungeonRun
{
    ...
    {
        SpriteComponent spriteComp; //this component changes the state of it's sprite component ref
        ...
        public AnimationComponent(SpriteComponent SpriteComp) { spriteComp = SpriteComp; }
