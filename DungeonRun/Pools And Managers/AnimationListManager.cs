...
namespace DungeonRun
{
    ...
    public static class AnimationListManager
    {
        ...
        public static void SetAnimationDirection(Actor ActorRef)
        {
            ...
            if (ActorRef.direction == Direction.Down) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.down; }
            else if (ActorRef.direction == Direction.Up) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.up; }
            else if (ActorRef.direction == Direction.Right) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.right; }
            else if (ActorRef.direction == Direction.Left) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.left; }
            //set diagonal directions
            else if (ActorRef.direction == Direction.DownRight) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.right; }
            else if (ActorRef.direction == Direction.DownLeft) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.left; }
            else if (ActorRef.direction == Direction.UpRight) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.right; }
            else if (ActorRef.direction == Direction.UpLeft) { ActorRef.animComp.currentAnimation = ActorRef.animGroup.left; }
        }
    }
}