...
{
	public static class RoomData_ThievesHideout_Columns
	{
		...
		static RoomData_ThievesHideout_Columns()
		{

			#region ThievesHideout_ColumnRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.ThievesHideout_ColumnRoom;
