...
{
	public static class RoomData_ThievesHideout_Square
	{
		...
		static RoomData_ThievesHideout_Square()
		{

			#region ThievesHideout_SquareRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.ThievesHideout_SquareRoom;
