...
namespace DungeonRun
{
	public static class RoomData_SkullIsland_ExitBossHub
	{
		...
		static RoomData_SkullIsland_ExitBossHub()
		{
			...
			#region SkullIsland_BossRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.SkullIsland_BossRoom;
			...
			#region SkullIsland_ExitRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.SkullIsland_ExitRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
			...
			#region SkullIsland_HubRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.SkullIsland_HubRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
