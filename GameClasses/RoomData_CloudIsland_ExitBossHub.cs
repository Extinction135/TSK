...
{
	public static class RoomData_CloudIsland_ExitBossHub
	{
		...
		static RoomData_CloudIsland_ExitBossHub()
		{

			#region CloudIsland_BossRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.CloudIsland_BossRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 72; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 88; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 104; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 120; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 136; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 152; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 168; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 184; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 200; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 216; obj.posY = 40; dataRef.ints.Add(obj);}
			{IntObjXmlData obj = new IntObjXmlData(); obj.type = InteractiveType.Coastline_1x2_Animated; obj.direction = Direction.Down; obj.posX = 232; obj.posY = 40; dataRef.ints.Add(obj);}
			...
			#region CloudIsland_ExitRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.CloudIsland_ExitRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
			...
			#region CloudIsland_HubRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.CloudIsland_HubRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
