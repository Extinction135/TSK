...
{
	public static class RoomData_LavaIsland_ExitBossHub
	{
		...
		static RoomData_LavaIsland_ExitBossHub()
		{

			#region LavaIsland_BossRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.LavaIsland_BossRoom;
			...
			#region LavaIsland_ExitRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.LavaIsland_ExitRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
			...
			#region LavaIsland_HubRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.LavaIsland_HubRoom;
			dataRef.windDirection = Direction.None;
			dataRef.windFrequency = 2;
			dataRef.windIntensity = 0;
