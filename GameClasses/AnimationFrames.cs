...
namespace DungeonRun
{
    public static class AnimationFrames
    {
        ...
        public static List<Byte4> Dungeon_FloorNormal = new List<Byte4> { new Byte4(7, 0, 0, 0) };
        public static List<Byte4> Dungeon_FloorSpecial = new List<Byte4> { new Byte4(7, 1, 0, 0) };
        ...
        public static List<Byte4> Dungeon_ExitLight = new List<Byte4> { new Byte4(2, 0, 0, 0) };

        public static List<Byte4> Dungeon_DoorOpen = new List<Byte4> { new Byte4(3, 0, 0, 0) };
        public static List<Byte4> Dungeon_DoorShut = new List<Byte4> { new Byte4(3, 1, 0, 0) };
        public static List<Byte4> Dungeon_DoorBoss = new List<Byte4> { new Byte4(3, 2, 0, 0) };

        public static List<Byte4> Dungeon_WallStraight = new List<Byte4> { new Byte4(4, 0, 0, 0) };
        public static List<Byte4> Dungeon_WallPillar = new List<Byte4> { new Byte4(4, 1, 0, 0) };
        public static List<Byte4> Dungeon_WallStraightCracked = new List<Byte4> { new Byte4(4, 2, 0, 0) };

        public static List<Byte4> Dungeon_WallInteriorCorner = new List<Byte4> { new Byte4(5, 0, 0, 0) };
        public static List<Byte4> Dungeon_WallStatue = new List<Byte4> { new Byte4(5, 1, 0, 0) };
        public static List<Byte4> Dungeon_WallExteriorCorner = new List<Byte4> { new Byte4(5, 2, 0, 0) };
        ...
        public static List<Byte4> Dungeon_BlockSpike = new List<Byte4> { new Byte4(2, 4, 0, 0) };
        ...
        public static List<Byte4> World_Bush = new List<Byte4> { new Byte4(7, 10, 0, 0) };
        public static List<Byte4> World_BushStump = new List<Byte4> { new Byte4(7, 11, 0, 0) };
        ...
        public static List<Byte4> World_Debris2 = new List<Byte4> { new Byte4(2, 11, 0, 0) };

        //interior building objs
        public static List<Byte4> World_Bookcase = new List<Byte4> { new Byte4(26, 11, 0, 0) };
        public static List<Byte4> World_Shelf = new List<Byte4> { new Byte4(27, 11, 0, 0) };
        public static List<Byte4> World_TableSingle = new List<Byte4> { new Byte4(28, 11, 0, 0) };
        public static List<Byte4> World_TableDoubleLeft = new List<Byte4> { new Byte4(29, 11, 0, 0) };
        public static List<Byte4> World_TableDoubleRight = new List<Byte4> { new Byte4(29, 11, 1, 0) };

        public static List<Byte4> Wor_Stove = new List<Byte4> { new Byte4(31, 11, 0, 0) };
        public static List<Byte4> Wor_Sink = new List<Byte4> { new Byte4(30, 11, 0, 0) };
        public static List<Byte4> Wor_Chair = new List<Byte4> { new Byte4(26, 10, 0, 0) };

        public static List<Byte4> Wor_Bed = new List<Byte4> { new Byte4(24, 5, 0, 0) };
        public static List<Byte4> Wor_BedDirty = new List<Byte4> { new Byte4(25, 5, 0, 0) };
        ...
        public static List<Byte4> Wor_Ditch_Empty_4UP = new List<Byte4> { new Byte4(20, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Vertical = new List<Byte4> { new Byte4(21, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Horizontal = new List<Byte4> { new Byte4(21, 9, 0, 0) };

        public static List<Byte4> Wor_Ditch_Empty_Corner_North = new List<Byte4> { new Byte4(22, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Corner_South = new List<Byte4> { new Byte4(22, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_3UP_North = new List<Byte4> { new Byte4(23, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_3UP_South = new List<Byte4> { new Byte4(23, 9, 0, 0) };

        public static List<Byte4> Wor_Ditch_Empty_3UP_Horizontal = new List<Byte4> { new Byte4(24, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Endcap_South = new List<Byte4> { new Byte4(24, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Endcap_Horizontal = new List<Byte4> { new Byte4(25, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Empty_Endcap_North = new List<Byte4> { new Byte4(25, 9, 0, 0) };

        //ditches - filled
        public static List<Byte4> Wor_Ditch_Filled_Single = new List<Byte4> { new Byte4(26, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_4UP = new List<Byte4> { new Byte4(26, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_Vertical = new List<Byte4> { new Byte4(27, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_Horizontal = new List<Byte4> { new Byte4(27, 9, 0, 0) };

        public static List<Byte4> Wor_Ditch_Filled_Corner_North = new List<Byte4> { new Byte4(28, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_Corner_South = new List<Byte4> { new Byte4(28, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_3UP_North = new List<Byte4> { new Byte4(29, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_3UP_South = new List<Byte4> { new Byte4(29, 9, 0, 0) };

        public static List<Byte4> Wor_Ditch_Filled_3UP_Horizontal = new List<Byte4> { new Byte4(30, 8, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_Endcap_South = new List<Byte4> { new Byte4(30, 9, 0, 0) };
        public static List<Byte4> Wor_Ditch_Filled_Endcap_Horizontal = new List<Byte4> { new Byte4(31, 8, 0, 0) };
        ...
        public static List<Byte4> Wor_MountainWall_Foothold = new List<Byte4> { new Byte4(10, 12, 0, 0) };
        public static List<Byte4> Wor_MountainWall_Ladder = new List<Byte4> { new Byte4(5, 15, 0, 0) };
        public static List<Byte4> Wor_MountainWall_Ladder_Trap = new List<Byte4> { new Byte4(4, 15, 0, 0) };
        ...
        public static List<Byte4> Wor_MountainWall_Cave_Covered = new List<Byte4> { new Byte4(4, 6, 0, 0) };
        ...
        public static List<Byte4> Wor_Boat_Front_Left = new List<Byte4> { new Byte4(0, 6, 0, 0) };
        public static List<Byte4> Wor_Boat_Front = new List<Byte4> { new Byte4(1, 6, 0, 0) };
        public static List<Byte4> Wor_Boat_Front_Right = new List<Byte4> { new Byte4(2, 6, 0, 0) };

        public static List<Byte4> Wor_Boat_Front_ConnectorLeft = new List<Byte4> { new Byte4(0, 21, 0, 0) };
        public static List<Byte4> Wor_Boat_Front_ConnectorRight = new List<Byte4> { new Byte4(2, 21, 0, 0) };

        public static List<Byte4> Wor_Boat_Bannister_Left = new List<Byte4> { new Byte4(0, 23, 0, 0) };
        public static List<Byte4> Wor_Boat_Bannister_Right = new List<Byte4> { new Byte4(2, 23, 0, 0) };

        public static List<Byte4> Wor_Boat_Stairs_Top_Left = new List<Byte4> { new Byte4(0, 12, 0, 0) };
        public static List<Byte4> Wor_Boat_Stairs_Top_Right = new List<Byte4> { new Byte4(2, 12, 0, 0) };

        public static List<Byte4> Wor_Boat_Stairs_Left = new List<Byte4> { new Byte4(0, 26, 0, 0) };
        public static List<Byte4> Wor_Boat_Stairs_Right = new List<Byte4> { new Byte4(2, 26, 0, 0) };

        public static List<Byte4> Wor_Boat_Stairs_Bottom_Left = new List<Byte4> { new Byte4(0, 27, 0, 0) };
        public static List<Byte4> Wor_Boat_Stairs_Bottom_Right = new List<Byte4> { new Byte4(2, 27, 0, 0) };
        ...
        //captain brandy
        public static List<Byte4> Wor_Boat_Captain_Brandy = new List<Byte4> { new Byte4(25, 26, 0, 0) };
        public static List<Byte4> Wor_Boat_Captain_Brandy_HandsUp = new List<Byte4>
        {
            new Byte4(25, 26, 0, 0), new Byte4(26, 26, 0, 0), new Byte4(25, 26, 0, 0), new Byte4(26, 26, 0, 0),
            new Byte4(25, 26, 0, 0), new Byte4(26, 26, 0, 0), new Byte4(25, 26, 0, 0), new Byte4(26, 26, 0, 0),
        };
        public static List<Byte4> Wor_Boat_Captain_Brandy_Blink = new List<Byte4>
        {
        ...
        #region Boss Specific Enemies

        //unique to floating eye - he spawns them
        ...
        public static List<Byte4> Vendor_EnemyItems = new List<Byte4> { new Byte4(15, 25, 0, 0), new Byte4(15, 25, 1, 0) };
        public static List<Byte4> Vendor_Items = new List<Byte4> { new Byte4(16, 25, 0, 0), new Byte4(16, 25, 1, 0) };
        public static List<Byte4> Vendor_Potions = new List<Byte4> { new Byte4(17, 25, 0, 0), new Byte4(17, 25, 1, 0) };
        public static List<Byte4> Vendor_Magic = new List<Byte4> { new Byte4(18, 25, 0, 0), new Byte4(18, 25, 1, 0) };
        public static List<Byte4> Vendor_Weapons = new List<Byte4> { new Byte4(19, 25, 0, 0), new Byte4(19, 25, 1, 0) };
        public static List<Byte4> Vendor_Armor = new List<Byte4> { new Byte4(20, 25, 0, 0), new Byte4(20, 25, 1, 0) };
        public static List<Byte4> Vendor_Equipment = new List<Byte4> { new Byte4(21, 25, 0, 0), new Byte4(21, 25, 1, 0) };
        public static List<Byte4> Vendor_Pets = new List<Byte4> { new Byte4(22, 25, 0, 0), new Byte4(22, 25, 1, 0) };

        public static List<Byte4> Vendor_Story = new List<Byte4> { new Byte4(23, 25, 0, 0), new Byte4(23, 25, 1, 0) };

        public static List<Byte4> NPC_Farmer = new List<Byte4> { new Byte4(24, 25, 0, 0), new Byte4(24, 25, 1, 0) };
        public static List<Byte4> NPC_Farmer_HandsUp = new List<Byte4> { new Byte4(24, 25, 0, 0), new Byte4(25, 25, 0, 0) };

        public static List<Byte4> Vendor_Colliseum_Mob = new List<Byte4> { new Byte4(21, 26, 0, 0), new Byte4(21, 26, 1, 0) };
        ...
        { new Byte4(29, 25, 0, 0), new Byte4(30, 25, 0, 0) };
        public static List<Byte4> Pet_Chicken_Move = new List<Byte4>
        { new Byte4(30, 25, 0, 0), new Byte4(31, 25, 0, 0) };
        ...
        { new Byte4(1, 16, 0, 0), new Byte4(1, 17, 1, 0) };
        public static List<Byte4> ActorFX_WetFeet = new List<Byte4> //16x8
        { new Byte4(9, 16, 0, 0), new Byte4(9, 17, 0, 0) };
        ...
        public static List<Byte4> Wind_Gust = new List<Byte4>
        {   //loop anim, 1x2 size
            new Byte4(13, 0, 0, 0), new Byte4(13, 1, 0, 0),
            new Byte4(13, 2, 0, 0), new Byte4(13, 3, 0, 0)
        };
        ...
        public static List<Byte4> Projectile_FireRod = new List<Byte4>
        {
            new Byte4(0, 13, 0, 0), new Byte4(1, 13, 0, 0),
            new Byte4(2, 13, 0, 0), new Byte4(3, 13, 0, 0)
        };

        public static List<Byte4> Projectile_IceRod = new List<Byte4>
        {
            new Byte4(0, 14, 0, 0), new Byte4(1, 14, 0, 0),
        ...
        public static List<Byte4> Projectile_ArrowHit = new List<Byte4> { new Byte4(7, 8, 0, 0) };


        public static List<Byte4> Projectile_Bomb = new List<Byte4>
        { new Byte4(8, 7, 0, 0), new Byte4(9, 7, 0, 0) };
        ...
        public static List<Byte4> Projectile_Iceball = new List<Byte4>
        { new Byte4(5, 7, 0, 0), new Byte4(5, 7, 1, 0) };
        ...
        public static List<Byte4> Particle_SparkleBlue = new List<Byte4>
        {
        ...
        static AnimationFrames()
        {
            ...
            Standard_AngryEye_Animations.idle.down = new List<Byte4> { new Byte4(0, 3, 0, 0), new Byte4(0, 3, 1, 0) };
            ...
            Standard_AngryEye_Animations.dash.down = new List<Byte4> { new Byte4(2, 3, 0, 0) }; //menacing
            ...
            Standard_AngryEye_Animations.hit.down = new List<Byte4> { new Byte4(1, 3, 0, 0) };
            ...
            MiniBoss_BlackEye_Animations.idle.down = new List<Byte4> { new Byte4(0, 2, 0, 0), new Byte4(1, 2, 0, 0) };
            ...
            MiniBoss_BlackEye_Animations.dash.down = new List<Byte4> { new Byte4(2, 2, 0, 0) };
            ...
            MiniBoss_BlackEye_Animations.hit.down = new List<Byte4> { new Byte4(3, 2, 0, 0) };
            ...
            {
                new Byte4(3, 2, 0, 0), new Byte4(4, 2, 0, 0),
                new Byte4(5, 2, 0, 0), new Byte4(6, 2, 0, 0),
                new Byte4(7, 2, 0, 0) //leftover cracked debris
            };
            ...
            { new Byte4(7, 3, 0, 0), new Byte4(7, 3, 1, 0) };
            ...
            {
                new Byte4(7, 5, 0, 0), new Byte4(7, 5, 1, 0), //eyes closed wobble x3
                new Byte4(7, 5, 0, 0), new Byte4(7, 5, 1, 0),
                new Byte4(7, 5, 0, 0), new Byte4(7, 5, 1, 0),
            };
            ...
            MiniBoss_SpiderUnarmored_Animations.death_blank.down = new List<Byte4>
            {
                ...
                new Byte4(7, 5, 0, 0), new Byte4(7, 5, 1, 0),
                new Byte4(7, 5, 0, 0), new Byte4(7, 5, 1, 0),
                new Byte4(6, 5, 0, 0) //squished spider death
            };
            ...
            MiniBoss_OctoMouth_Animations.idle.down = new List<Byte4> { new Byte4(11, 6, 1, 0) };
            MiniBoss_OctoMouth_Animations.idle.up = new List<Byte4> { new Byte4(9, 6, 1, 0) };
            MiniBoss_OctoMouth_Animations.idle.right = new List<Byte4> { new Byte4(9, 6, 0, 0) };
            MiniBoss_OctoMouth_Animations.idle.left = new List<Byte4> { new Byte4(11, 6, 0, 0) };

            //attack
            MiniBoss_OctoMouth_Animations.attack = new AnimationGroup();
            //same magic used for attack as well
            MiniBoss_OctoMouth_Animations.attack.down = new List<Byte4> { new Byte4(10, 6, 1, 0) };
            MiniBoss_OctoMouth_Animations.attack.up = new List<Byte4> { new Byte4(8, 6, 1, 0) };
            MiniBoss_OctoMouth_Animations.attack.right = new List<Byte4> { new Byte4(8, 6, 0, 0) };
            MiniBoss_OctoMouth_Animations.attack.left = new List<Byte4> { new Byte4(10, 6, 0, 0) };

            //underwater
            MiniBoss_OctoMouth_Animations.underwater_idle = new AnimationGroup();
            MiniBoss_OctoMouth_Animations.underwater_idle.down = 
                new List<Byte4> { new Byte4(12, 6, 0, 0), new Byte4(12, 6, 1, 0) };
            ...
            Boss_BigEye_Animations.idle.down = new List<Byte4> { new Byte4(0, 0, 0, 0), new Byte4(1, 0, 0, 0) };
            ...
            Boss_BigEye_Animations.hit.down = new List<Byte4> { new Byte4(4, 0, 0, 0), new Byte4(4, 0, 1, 0) };
            ...
            {   //repeating hit frames
                new Byte4(5, 0, 0, 0), new Byte4(4, 0, 0, 0),
                new Byte4(5, 0, 0, 0), new Byte4(4, 0, 0, 0),
                new Byte4(5, 0, 0, 0), new Byte4(4, 0, 0, 0),
                new Byte4(5, 0, 0, 0), new Byte4(6, 0, 0, 0),
                new Byte4(7, 0, 0, 0)
            };
            ...
            {   //oscillate between 3 frames
                new Byte4(8, 2, 0, 0), new Byte4(9, 2, 0, 0),
                new Byte4(10, 2, 0, 0), new Byte4(9, 2, 0, 0)
            };
            ...
            { new Byte4(8, 3, 0, 0), new Byte4(9, 3, 0, 0) };
            Special_Tentacle_Animations.idle.left = new List<Byte4>
            { new Byte4(8, 3, 1, 0), new Byte4(9, 3, 1, 0) };
            ...
            Special_Tentacle_Animations.dash.down = new List<Byte4> { new Byte4(13, 3, 1, 0) };
            Special_Tentacle_Animations.dash.up = new List<Byte4> { new Byte4(13, 3, 0, 0) };
            Special_Tentacle_Animations.dash.right = new List<Byte4> { new Byte4(13, 3, 1, 0) };
            Special_Tentacle_Animations.dash.left = new List<Byte4> { new Byte4(13, 3, 0, 0) };
            ...
            { new Byte4(14, 3, 1, 0), new Byte4(15, 3, 1, 0) };
            Special_Tentacle_Animations.underwater_idle.left = new List<Byte4>
            { new Byte4(14, 3, 0, 0), new Byte4(15, 3, 0, 0) };
            ...
            {   //anticipation frames
                new Byte4(11, 3, 0, 0), new Byte4(11, 3, 0, 0),
                //attack frames
                new Byte4(10, 3, 0, 0), new Byte4(10, 3, 0, 0)
            };
