...
namespace DungeonRun
{
    public static class AnimationFrames
    {
        ...
        public static List<Byte4> Wor_Boat_Back_Left = new List<Byte4> { new Byte4(0, 3, 0, 0) };
        public static List<Byte4> Wor_Boat_Back_Left_Connector = new List<Byte4> { new Byte4(1, 3, 0, 0) };
        public static List<Byte4> Wor_Boat_Back_Center = new List<Byte4> { new Byte4(1, 3, 0, 0) };
        public static List<Byte4> Wor_Boat_Back_Right_Connector = new List<Byte4> { new Byte4(4, 3, 0, 0) };
        public static List<Byte4> Wor_Boat_Back_Right = new List<Byte4> { new Byte4(5, 3, 0, 0) };

        public static List<Byte4> Wor_Boat_Floor = new List<Byte4> { new Byte4(0, 4, 0, 0) };
        public static List<Byte4> Wor_Boat_Barrel = new List<Byte4> { new Byte4(4, 4, 0, 0) };
        ...
        public static List<Byte4> Wor_Boat_Ship_Destination = new List<Byte4> { new Byte4(6, 1, 0, 0) };
        ...
        {
            new Byte4(7, 0, 0, 0), new Byte4(6, 0, 0, 0), new Byte4(7, 0, 0, 0), new Byte4(6, 0, 0, 0),
            new Byte4(7, 0, 0, 0), new Byte4(6, 0, 0, 0), new Byte4(7, 0, 0, 0), new Byte4(6, 0, 0, 0),
        };
        public static List<Byte4> Wor_Boat_Captain_Brandy_Blink = new List<Byte4>
        {
            new Byte4(8, 0, 0, 0), new Byte4(6, 0, 0, 0), new Byte4(8, 0, 0, 0), new Byte4(6, 0, 0, 0)
        };
