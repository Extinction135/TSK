...
{
	public static class RoomData_HauntedSwamps_Square
	{
		...
		static RoomData_HauntedSwamps_Square()
		{

			#region HauntedSwamps_SquareRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.HauntedSwamps_SquareRoom;
