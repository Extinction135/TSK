...
{
	public static class RoomData_DeathMountain_Columns
	{
		...
		static RoomData_DeathMountain_Columns()
		{

			#region DeathMountain_ColumnRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.DeathMountain_ColumnRoom;
