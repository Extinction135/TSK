...
{
	public static class RoomData_DeathMountain_Square
	{
		...
		static RoomData_DeathMountain_Square()
		{

			#region DeathMountain_SquareRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.DeathMountain_SquareRoom;
