...
{
	public static class RoomData_HauntedSwamps_Columns
	{
		...
		static RoomData_HauntedSwamps_Columns()
		{

			#region HauntedSwamps_ColumnRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.HauntedSwamps_ColumnRoom;
