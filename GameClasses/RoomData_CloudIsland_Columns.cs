...
{
	public static class RoomData_CloudIsland_Columns
	{
		...
		static RoomData_CloudIsland_Columns()
		{

			#region CloudIsland_ColumnRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.CloudIsland_ColumnRoom;
