...
{
	public static class RoomData_LavaIsland_Columns
	{
		...
		static RoomData_LavaIsland_Columns()
		{

			#region LavaIsland_ColumnRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.LavaIsland_ColumnRoom;
