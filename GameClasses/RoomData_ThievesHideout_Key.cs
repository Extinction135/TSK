...
{
	public static class RoomData_ThievesHideout_Key
	{
		...
		static RoomData_ThievesHideout_Key()
		{

			#region ThievesHideout_KeyRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.ThievesHideout_KeyRoom;
