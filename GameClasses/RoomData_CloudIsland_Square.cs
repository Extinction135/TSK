...
{
	public static class RoomData_CloudIsland_Square
	{
		...
		static RoomData_CloudIsland_Square()
		{

			#region CloudIsland_SquareRoom

			dataRef = new RoomXmlData();
			dataRef.type = RoomID.CloudIsland_SquareRoom;
